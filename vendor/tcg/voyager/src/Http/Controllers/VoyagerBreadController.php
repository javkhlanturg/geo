...
class VoyagerBreadController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()
            ...
            ->with([
                'message'    => "Амжилттай засагдлаа {$dataType->display_name_singular}",
                'alert-type' => 'success',
            ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()
            ->route("{$dataType->slug}.index")
            ->with([
                'message'    => "Амжилттай бүртгэгдлээ {$dataType->display_name_singular}",
                'alert-type' => 'success',
            ]);
    }
    ...
    public function destroy(Request $request, $id)
    {
        ...
        $data = $data->destroy($id)
            ? [
                'message'    => "Амжилттай устгагдлаа {$dataType->display_name_singular}",
                'alert-type' => 'success',
            ]
            : [
                'message'    => "Уучлаарай устгах үед ямар нэг алдаа гарлаа: {$dataType->display_name_singular}",
                'alert-type' => 'error',
            ];
