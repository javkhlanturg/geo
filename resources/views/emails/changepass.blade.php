						...
						<table id="emailBody" width="500" cellspacing="0" cellpadding="0" border="0" bgcolor="#FFFFFF">
							...
							<tbody><tr>
								<td valign="top" align="center">
									...
									-->
									<table style="color:#FFFFFF;" width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#fc7100">
										<tbody><tr>
											<td valign="top" align="center">
												<!-- FLEXIBLE CONTAINER // -->
												<!--
															...
															<table width="100%" cellspacing="0" cellpadding="30" border="0">
																<tbody><tr>
																	<td class="textContent" valign="top" align="center">
																		<h2 style="color:#FFFFFF;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:23px;font-weight:normal;margin-bottom:5px;text-align:center;">{{ Voyager::setting('admin_title', 'Voyager') }}</h2>
																	</td>
																</tr>
															</tbody></table>
															<!-- // CONTENT TABLE -->
																		...
																		<table width="100%" cellspacing="0" cellpadding="0" border="0">
																			<tbody><tr>
																				<td class="textContent" valign="top">
																					<h3 style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">Сайн байна уу ?</h3>
																					<div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:3px;color:#5F5F5F;line-height:135%;">Та <a href='{{url("user/change/pass/{$user->token}")}}'>энд дарж</a> нууц үгээ солино уу.</div>
																				</td>
																			</tr>
																		</tbody></table>
																		<!-- // CONTENT TABLE -->
															...
															<table class="flexibleContainerCellDivider" width="100%" cellspacing="0" cellpadding="30" border="0">
																<tbody><tr>
																	<td style="padding-top:0px;padding-bottom:0px;" valign="top" align="center">
																		...
																		<table width="100%" cellspacing="0" cellpadding="0" border="0">
																			<tbody><tr>
																				<td style="border-top:1px solid #C8C8C8;" valign="top" align="center"></td>
																			</tr>
																		</tbody></table>
																		<!-- // CONTENT TABLE -->
