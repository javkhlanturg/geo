            ...
            <li>
                <div class="comment-main-level">
					...
					<li class="depth-1">
						...
						<div class="comment-text"><p>{{$comment->comment}}</p></div>
					</li>
          @endforeach
				</ol>
				<!-- End Comments -->
				...
				<div class="contact-form comment cleafix">
					<form id="contact">
						<input name="username" class="left" type="text" data-value="Name" value="Нэр">
						<textarea name="comment" class="twelve column" data-value="Comment">Сэтгэгдэл</textarea>
